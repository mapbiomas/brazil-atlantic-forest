...
var mosaicoTotal = mos.getMosaic(ano,limite);
  ...
  var bandNames = ee.List([
                  ...
                  'swir1_median','lswi_median_wet','green_median_wet','iia_median_wet','red_median_wet','afvi_median_wet','iia_median','getness_median_wet','ratio_median_wet','swir1_median_wet','gli_median_dry','evi_median_dry','bsi_median_2','getness_median_dry','evi_median_wet','mbi_median_wet','dswi5_median','gvmi_median_dry_1','shape_median',
...
Map.addLayer(mosaicoTotal.clip(limite.geometry()), visParMedian2, 'Img_Year_'+ano, false);
  ...
  var amostraTotal = varzea.merge(agro).merge(flo).merge(reflo)//.merge(aflora)//.merge(agua)
