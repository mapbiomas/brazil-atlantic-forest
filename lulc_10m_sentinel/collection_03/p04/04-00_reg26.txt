...
var mosaicoTotal = mos.getMosaic(ano,limite);
  ...
  var bandNames = ee.List([
                  ...
                  'wetness_median_dry','brba_median','ndwi_median','dswi5_median','blue_median','red_median','brba_median_wet','gvmi_median_wet_1','red_edge_1_median','nddi_median_wet','iia_median','red_edge_1_median_wet','wetness_median','cvi_median','dswi5_median_wet','brightness_median_dry','lswi_median','nir_median_dry','co2flux_median',
...
print('training_reflo',training_reflo.size())
  ...
  var training = BDflo.merge(BDreflo).merge(BDcampo)//.merge(BDsav).merge(BDOutroNFlo).merge(BDAflora)
                      ...
                      // .merge(training_afl)
                      .merge(training_flo).merge(training_cam)
