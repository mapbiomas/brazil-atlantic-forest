...
var mosaicoTotal = mos.getMosaic(ano,limite);
  ...
  var bandNames = ee.List([
                  ...
                  'nddi_median','nddi_median_wet','spri_median_wet','lai_median','ndwi_median_wet','swir2_median_wet','bsi_median_1','ui_median_wet','iia_median','swir2_median','dswi5_median','mbi_median_wet','ratio_median_dry','iia_median_dry','gemi_median','red_median_dry','osavi_median_wet','bsi_median','ri_median_wet',
...
Map.addLayer(mosaicoTotal.clip(limite.geometry()), visParMedian2, 'Img_Year_'+ano, false);
  ...
  var amostraTotal = varzea.merge(herb).merge(flo).merge(agro)//.merge(agua)
  ...
  var training_herb = mosaicoTotal.select(bandNames).addBands(amostraTotalimg).sample({'numPixels': 1000, 'region': herb.filterBounds(limite), 'scale': 10, 'seed': 1});
