
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-32.37796136639269, -3.803879138409012],
                  [-32.37796136639269, -3.816511181967586],
                  [-32.39465543530138, -3.816511181967586],
                  [-32.39465543530138, -3.803879138409012]]], null, false),
            {
              "remap": 100,
              "system:index": "14"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-32.41675820633355, -3.867785696364683],
                  [-32.41675820633355, -3.8689738838938665],
                  [-32.41997685715142, -3.8689738838938665],
                  [-32.41997685715142, -3.867785696364683]]], null, false),
            {
              "remap": 100,
              "system:index": "15"
            })]);

// Define the asset description metadata string.
var description = 'Corrige FN'

// Define the standard collection identification value.
...
var class4GAP = ee.Image('projects/mapbiomas-workspace/COLECAO3_S2/MATA_ATLANTICA/classificacao-ma-S2/FNoronha_p06_v'+vesion_in)//.mask(bioma250mil_MA);
...
Map.addLayer(class4GAP.select('classification_2023'), vis, 'class4GAP');
...
for (var i_ano=0;i_ano<anos.length; i_ano++){
  // Get the current iteration year value.
  var ano = anos[i_ano];

  // Extract the specific single-year classification band image.
  ...
  // Overlay newly remapped data on top of the image.
  class_remap0 = class4GAP.blend(class_remap0)

  // Apply the masks to the classification image
  var class_remap1 = class_remap0.add(praia_agua.reduceToImage({properties: ['remap'],reducer: ee.Reducer.first()}))
                                          .remap([3,12,19,23,24,25,29,33,103,112,119,123,124,125,129,133],
                                                 [3,12,19,23,24,25,29,33,  3, 12, 19, 33, 24, 25, 29, 33])
                                          .rename('classification_'+ano);
  // Overlay subsequent water-remapped corrections over the image.
  class_remap1 = class_remap0.blend(class_remap1)

  // Map non-vegetated transitions based on input vector datasets.
  var class_remap2 = class_remap1.add(aflora_e_agua_para_nao_veg.reduceToImage({properties: ['remap'],reducer: ee.Reducer.first()}))
                                          ...
                                          .rename('classification_'+ano);
  // Overlay non-vegetation remapped collections onto the workspace layer.
  class_remap2 = class_remap1.blend(class_remap2)

  // Remap specified beach elements directly to urban land classes.
  var class_remap3 = class_remap2.add(praia_para_urbano.reduceToImage({properties: ['remap'],reducer: ee.Reducer.first()}))
                                          ...
                                          .rename('classification_'+ano);
  // Overlay urban transformation corrections across the baseline map image.
  class_remap3 = class_remap2.blend(class_remap3)

  // Convert specified infrastructure structures into proper beach classifications.
  var class_remap4 = class_remap3.add(urbano_para_praia.reduceToImage({properties: ['remap'],reducer: ee.Reducer.first()}))
                                          ...
                                          .rename('classification_'+ano);
  // Layer updated beach attributes explicitly across the processing image.
  class_remap4 = class_remap3.blend(class_remap4)

  // Map incorrect built layers into accurate rocky outcrop indices.
  var class_remap5 = class_remap4.add(urbano_para_aflora.reduceToImage({properties: ['remap'],reducer: ee.Reducer.first()}))
                                          ...
                                          .rename('classification_'+ano);
  // Layer localized outcrop definitions over current spatial layout.
  ...
  class_remap5 = class_remap5.remap([3,12,19,21,23,24,25,29,33],
    ...
    if (i_ano == 0){ var class_outTotal = class_remap5;}  
    // Otherwise, add the current year's classification to the image
    else {class_outTotal = class_outTotal.addBands(class_remap5);}
                                     
  // Add the remapped classification images to the map
  Map.addLayer(class_remap0.select('classification_'+ano), vis, 'class_remap0 '+ano, false);
  Map.addLayer(class_remap1.select('classification_'+ano), vis, 'class_remap1 '+ano, false);
  Map.addLayer(class_remap2.select('classification_'+ano), vis, 'class_remap2 '+ano, false);
  Map.addLayer(class_remap3.select('classification_'+ano), vis, 'class_remap3 '+ano, false);
  Map.addLayer(class_remap4.select('classification_'+ano), vis, 'class_remap4 '+ano, false);
  Map.addLayer(class_remap5.select('classification_'+ano), vis, 'class_remap5 '+ano, true);
  // Map.addLayer(class_out2, vis, 'class_out2');
}

// Print unified multi-band collection to logs.
