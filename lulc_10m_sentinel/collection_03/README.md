...
Step 03-20: export trained samples for sentinel bands for each year

Step 03-30: join trained samples from embeddings and sentinel

Step 03-40: runs the feature importance per region
