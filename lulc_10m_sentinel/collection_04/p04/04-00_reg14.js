...
var mosaicoTotal = mos.getMosaic(ano,limite);
  ...
  var bandNames = ee.List([
                  ...
                  'evi_median','wetness_median_dry','cvi_median','ratio_median','gemi_median','wetness_median','red_edge_1_median_dry','ri_median_wet','red_edge_4_median_wet','awei_median_wet','gli_median','red_edge_2_stdDev','wetness_median_wet','swir2_median','swir1_median_dry','lswi_median_wet','mbi_median','evi_median_dry','mbi_median_wet',
...
Map.addLayer(mosaicoTotal.clip(limite.geometry()), visParMedian2, 'Img_Year_'+ano, false);
  ...
  // Sample the mosaic for the bare soil class
