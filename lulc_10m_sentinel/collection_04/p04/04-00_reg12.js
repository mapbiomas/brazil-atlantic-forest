...
var mosaicoTotal = mos.getMosaic(ano,limite);
  ...
  var bandNames = ee.List([
                  ...
                  'ri_median_wet','green_median','afvi_median_wet','swir1_median_dry','cvi_median','gemi_median','red_edge_2_median','brightness_median_dry','gli_median','red_edge_4_median_wet','shape_median','gcvi_median_dry','mbi_median_dry','lswi_median','gli_median_dry','evi_median','ratio_median','swir2_stdDev','ndwi_median_dry',
...
Map.addLayer(mosaicoTotal.clip(limite.geometry()), visParMedian2, 'Img_Year_'+ano, false);
  ...
  var amostraTotal = flo.merge(agr).merge(agua).merge(varzea).merge(campo).merge(reflo)
