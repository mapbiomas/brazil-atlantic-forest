...
var mosaicoTotal = mos.getMosaic(ano,limite);
  ...
  var bandNames = ee.List([
                  ...
                  'wetness_median_wet','iia_median_dry','gcvi_median_wet','blue_median','nddi_median','msi_median','swir2_stdDev','gvmi_median_dry_1','ratio_median_wet','red_median','wetness_median_dry','swir2_median_wet','green_median_wet','afvi_median_wet','brightness_median','rvi_median','rvi_median_wet','iia_median','swir2_median',
...
Map.addLayer(mosaicoTotal.clip(limite.geometry()), visParMedian2, 'Img_Year_'+ano, false);
  ...
  var amostraTotal = varzea.merge(agro).merge(flo).merge(campo)//flo.merge(agr).merge(agua).merge(varzea)
