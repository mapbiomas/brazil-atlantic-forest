...
var mosaicoTotal = mos.getMosaic(ano,limite);
  ...
  var bandNames = ee.List([
                  ...
                  'red_edge_1_median_wet','red_median_wet','iia_median','swir1_stdDev','ndvi_median_wet','swir2_median_wet','iia_median_wet','evi_median_dry','brightness_median','swir2_median','ri_median_dry','spri_median_1','red_edge_1_median','avi_median_wet','gvmi_median_wet_1','gvmi_median','dswi5_median_wet','gcvi_median','ndvi_median',
...
Map.addLayer(mosaicoTotal.clip(limite.geometry()), visParMedian2, 'Img_Year_'+ano, false);
  ...
  var amostraTotal = herb.merge(agro).merge(sav).merge(umida).merge(flo)
...
//print('training_agu',training_agu.size())
  ...
  var training = BDflo.merge(BDreflo).merge(BDcampo).merge(BDherb)//.merge(BDOutroNFlo).merge(BDAflora)
                      ...
                      //complementares
                      .merge(training_flo).merge(training_umd).merge(training_agr).merge(training_sav).merge(training_herb)//.merge(training_agr)
                      //.merge(training_agu)
                      //.merge(training_cam)
