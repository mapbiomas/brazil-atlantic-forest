...
var camp_compl = 
    ...
    ee.FeatureCollection(
        [ee.Feature(
            ee.Geometry.Polygon(
                [[[-48.99810338425932, -25.9014365039963],
                  [-48.998532537701706, -25.897035524684515],
                  [-49.00273824143706, -25.901050459747243]]]),
            {
              "reference": 12,
              "system:index": "0"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-48.99218106675444, -25.88537599674453],
                  [-48.99097943711577, -25.886225405219918],
                  [-48.986344579938034, -25.883677161461943]]]),
            {
              "reference": 12,
              "system:index": "1"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-48.95695718634396, -25.882835900068855],
                  [-48.95627054083615, -25.885615819429034],
                  [-48.95386728155881, -25.88530694273214]]]),
            {
              "reference": 12,
              "system:index": "2"
            })]);
...
'red_median_wet',	'ndvi_median_wet',	'evi2_median_wet',	'savi_median_wet',	'gcvi_median',	'gcvi_stdDev',	'red_median',	
'hallcover_median_wet',	'ndvi_median',	'green_median_wet',	'swir1_median',	'gcvi_median_wet',	'ndvi_max',	'shade_median_wet',	
'hallcover_min',	'ndwi_stdDev',	'green_median',	'evi2_median',	'gcvi_amp',	'savi_max',	'blue_median_dry',	'red_min',	'cai_median_wet',	
'gcvi_max',	'evi2_max',	'gcvi_median_dry',	'swir2_min',	'nir_max',	'cai_median',	'savi_median',	'red_max',	'gcvi_min',	'green_median_dry',	
'swir2_max',	'blue_max',	'green_min',	'nir_stdDev',	'wefi_max',	'blue_median_wet',	'blue_min',	'savi_median_dry',	'evi2_median_dry',	
'wefi_median',	'nir_median',	'nir_median_wet',	'cai_min',	'shade_min',	'wefi_median_wet',	'ndvi_min',	'hallheigth_median_dry',	
'green_max',	'ndwi_median',	'blue_median',	'gv_max',	'hallheigth_max',	'hallheigth_min',	'ndwi_median_dry',

// 'swir2_amp',	'swir2_median_wet',
...
var batch8 = ee.FeatureCollection('projects/mapbiomas-brazil/assets/LAND-COVER/COLLECTION-11/GENERAL/SAMPLES/MATAATLANTICA/amostras_complementares_b8_'+regiaoID)
  ...
  var flo      = complementares.filter(ee.Filter.eq('reference', 3)).sort('random').limit(300)
  ...
  var herb     = complementares.filter(ee.Filter.eq('reference', 50)).sort('random').limit(500)
  ...
  var aflora   = complementares.filter(ee.Filter.eq('reference', 29)).sort('random').limit(700)
...
var amostraTotal = camp_compl
  ...
  var training = BDflo.merge(BDreflo).merge(BDcampo)
                      ...
                      .merge(BDagua)
                      // complementary samples
                      .merge(flo).merge(varzea).merge(herb).merge(agro).merge(aflora).merge(training_camp);
...
//Map.setCenter(-46.67431, -24.48566, 11)
