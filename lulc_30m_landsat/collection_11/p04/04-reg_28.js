...
'ndvi_median_wet',	'fns_median_dry',	'green_median_texture',	'blue_median_wet',	'nir_min',	'green_median_dry',	
...
var batch8 = ee.FeatureCollection('projects/mapbiomas-brazil/assets/LAND-COVER/COLLECTION-11/GENERAL/SAMPLES/MATAATLANTICA/amostras_complementares_b8_'+regiaoID)
  ...
  var campo    = complementares.filter(ee.Filter.eq('reference', 12)).sort('random').limit(1000)
...
Map.setCenter(-50.3355, -25.1304, 11)
