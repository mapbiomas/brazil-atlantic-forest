...
'gcvi_median_dry',	'savi_median_dry',	'red_stdDev',
...
var batch8 = ee.FeatureCollection('projects/mapbiomas-brazil/assets/LAND-COVER/COLLECTION-11/GENERAL/SAMPLES/MATAATLANTICA/amostras_complementares_b8_'+regiaoID)
  ...
  var varzea   = complementares.filter(ee.Filter.eq('reference', 11)).sort('random').limit(600)
  ...
  var agro     = complementares.filter(ee.Filter.eq('reference', 21)).sort('random').limit(800)
