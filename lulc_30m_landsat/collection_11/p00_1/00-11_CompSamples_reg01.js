 ...
 * OBJECTIVE: Extraction of complementary training samples for land cover classification, focusing on the region 'reg_01'.
 * 
 * DESCRIPTION:
 * This script automates the process of collecting training samples across multiple years and classes 
 * within the Atlantic Forest biome, specifically configured for the region identified as 'reg_01'. 
 ...
 * user-defined geometries for various land cover classes, and the resulting feature collections 
...
var aflora = /* color: #98ff00 */ee.FeatureCollection(
        [ee.Feature(
            ee.Geometry.Polygon(
        ...
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.3785751953916, -21.80405075328232],
                  [-44.377416481097164, -21.80588361900698],
                  [-44.37647234352392, -21.804528894428472]]]),
            {
              "reference": 12,
              "system:index": "25"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.2076510898914, -21.828393761907677],
                  [-44.208251904710735, -21.826640862184345],
                  [-44.20885271953007, -21.82823440827496]]]),
            {
              "reference": 12,
              "system:index": "26"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.67828494671019, -22.044349095444257],
                  [-44.674508396417224, -22.051668050522657],
                  [-44.67588168743285, -22.04482643014296]]]),
            {
              "reference": 12,
              "system:index": "27"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.70575076702269, -22.04228062647586],
                  [-44.70111590984496, -22.04092814964877],
                  [-44.70523578289183, -22.039257425135027]]]),
            {
              "reference": 12,
              "system:index": "28"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.691674534112536, -22.029789613726102],
                  [-44.68661052349242, -22.030664816129605],
                  [-44.69090205791625, -22.02875527663866]]]),
            {
              "reference": 12,
              "system:index": "29"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.674300204833614, -22.013364593553902],
                  [-44.6721544376217, -22.015990489002395],
                  [-44.67241192968713, -22.012887152790114]]]),
            {
              "reference": 12,
              "system:index": "30"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.727944385131465, -21.996334878789472],
                  [-44.72236539038049, -22.000871030702672],
                  [-44.72116376074182, -21.99752861704369]]]),
            {
              "reference": 12,
              "system:index": "31"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.740939652935815, -21.986757694114832],
                  [-44.735188996807885, -21.988906560800928],
                  [-44.74188379050906, -21.982778225438302]]]),
            {
              "reference": 12,
              "system:index": "32"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.70042756797488, -21.982539453769416],
                  [-44.698710954205346, -21.985086330861755],
                  [-44.69733766318972, -21.98333535777029]]]),
            {
              "reference": 12,
              "system:index": "33"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.670335852113496, -22.010249861782622],
                  [-44.66604431768967, -22.008260470937472],
                  [-44.66767510077072, -22.00650978389838]]]),
            {
              "reference": 12,
              "system:index": "34"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.784748159852754, -21.94108226691724],
                  [-44.78466232916428, -21.94530173834506],
                  [-44.78260239264084, -21.94108226691724]]]),
            {
              "reference": 12,
              "system:index": "35"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.77307518621994, -21.96775040511545],
                  [-44.770242773500215, -21.97029754750889],
                  [-44.769212805238496, -21.96703401308724]]]),
            {
              "reference": 12,
              "system:index": "36"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.16053695790727, -21.916757001761784],
                  [-44.15521545522172, -21.92272893589041],
                  [-44.15624542348344, -21.916757001761784]]]),
            {
              "reference": 12,
              "system:index": "37"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.17504234425981, -21.925356507551392],
                  [-44.1758148204561, -21.933238931505702],
                  [-44.17341156117875, -21.926391598222516]]]),
            {
              "reference": 12,
              "system:index": "38"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.21624107472856, -21.95369934728828],
                  [-44.213837815451214, -21.95489344405036],
                  [-44.212292863058636, -21.952346025497842]]]),
            {
              "reference": 12,
              "system:index": "39"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.12946624867875, -21.913332979900726],
                  [-44.12448806874711, -21.915642212984412],
                  [-44.127921296286175, -21.912536683949238]]]),
            {
              "reference": 12,
              "system:index": "40"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.65756591966096, -22.060334512986724],
                  [-44.65404686143342, -22.058425373861997],
                  [-44.65524849107209, -22.05691395377335]]]),
            {
              "reference": 12,
              "system:index": "41"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.71078094651643, -21.994056407820786],
                  [-44.708892671369945, -21.99747848557285],
                  [-44.706146089338695, -21.996443912634025]]]),
            {
              "reference": 12,
              "system:index": "42"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.70108207871858, -21.998990540139197],
                  [-44.699537126326, -22.002412498839355],
                  [-44.69979461839143, -21.998194723955876]]]),
            {
              "reference": 12,
              "system:index": "43"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.67284378220979, -22.03750270234998],
                  [-44.67164215257112, -22.041162404275795],
                  [-44.67164215257112, -22.037025342948446]]]),
            {
              "reference": 12,
              "system:index": "44"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.687626591234206, -22.051010999032226],
                  [-44.68651079228401, -22.054113499680145],
                  [-44.6858241467762, -22.049499499704968]]]),
            {
              "reference": 12,
              "system:index": "45"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.68196176579475, -22.055306751038515],
                  [-44.6777560620594, -22.05538630077109],
                  [-44.68127512028694, -22.05236337947649]]]),
            {
              "reference": 12,
              "system:index": "46"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.68857072880745, -22.040748396735456],
                  [-44.68805574467659, -22.044805793591962],
                  [-44.68711160710335, -22.04178264619742]]]),
            {
              "reference": 12,
              "system:index": "47"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.62340475146401, -22.02302020038005],
                  [-44.624005566283344, -22.025168517492972],
                  [-44.62108732287514, -22.022542792152212]]]),
            {
              "reference": 12,
              "system:index": "48"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.50776027336773, -21.981244143131466],
                  [-44.50252460137066, -21.98633789809945],
                  [-44.50080798760113, -21.985860366337416]]]),
            {
              "reference": 12,
              "system:index": "49"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.51351092949566, -21.979572714950276],
                  [-44.51196597710308, -21.98180128148501],
                  [-44.510592686087456, -21.979493122641248]]]),
            {
              "reference": 12,
              "system:index": "50"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.146916481420476, -21.913998592529403],
                  [-44.14129457132526, -21.91236618866614],
                  [-44.14580068247028, -21.91188840838655]]]),
            {
              "reference": 12,
              "system:index": "51"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.13026532785602, -21.920886334499777],
                  [-44.12829122202106, -21.924469421116278],
                  [-44.12717542307087, -21.920567833547494]]]),
            {
              "reference": 12,
              "system:index": "52"
            })]),
    ...
    campo = /* color: #98ff00 */ee.FeatureCollection(
        ...
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.19708067982162, -21.107581612569223],
                  [-44.169443198132164, -21.0854801082291],
                  [-44.200857230114586, -21.104698994204107]]]),
            {
              "reference": 12,
              "system:index": "46"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.14815718738998, -21.06786061216006],
                  [-44.16532332508529, -21.081155516217546],
                  [-44.142492361950524, -21.069782840472097]]]),
            {
              "reference": 12,
              "system:index": "47"
            }),
        ...
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.11472670638971, -21.05461616961309],
                  [-44.113868399504945, -21.062145425570666],
                  [-44.110606833342835, -21.055256972184978]]]),
            {
              "reference": 12,
              "system:index": "72"
            }),
        ...
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.16216780577748, -21.819841246725865],
                  [-44.16311194335072, -21.82191295163725],
                  [-44.161481160269666, -21.82183327123372]]]),
            {
              "reference": 12,
              "system:index": "81"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.17641570006459, -21.818646018711007],
                  [-44.17864729796498, -21.817291414893607],
                  [-44.177960652457166, -21.81976156516878]]]),
            {
              "reference": 12,
              "system:index": "82"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-44.27080918579102, -21.94300097510905],
                  [-44.26995087890626, -21.94140871068777],
                  [-44.27269746093751, -21.942045618595408]]]),
            {
              "reference": 12,
              "system:index": "83"
            })]);
...
// Filter the master collection to obtain the specific geometry of region 'reg_01'
...
for (var i = 0; i < dicExp.length; i++) {
  ...
  for (var i_ano=0; i_ano<anos.length; i_ano++){
    ...
    // Print the sorted list of available bands for debugging purposes
    ...
    var bandNames = ee.List([
      ...
      'savi_median_wet',	'shade_stdDev',	'ndvi_max',	'hallcover_max',	'swir2_min', 'latitude', 'longitude', 'slope',
    ]);
    ...
    // Mapping of available class labels to their target sample sizes and numeric reference IDs
    var classConfigs = [
      {variable: typeof flo     !== 'undefined' ? flo     : null, number:  750, ref: 3,  name: 'floresta'},
      {variable: typeof sav     !== 'undefined' ? sav     : null, number:  600, ref: 4,  name: 'savana'},
      ...
      {variable: typeof campo   !== 'undefined' ? campo   : null, number: 1200, ref: 12, name: 'campo'},
    ...
    // --- 3. SAMPLING FUNCTION ---
    // Function designed to extract raster pixel values using spatial geometries for region 'reg_01'
    var getTrainingSamples = function(classObj) {
      // Filter the class geometries by the current regional limit ('reg_01')
    ...
    // Iterate through active classes to collect samples for the specific year in region 'reg_01'
    ...
    // Merge the year's samples into the multi-year batch collection
    if (i_ano == 0){  
  ...
  // Export the final multi-year batch collection for 'reg_01' as an Earth Engine Asset
...
// Print the processed classes to the console for verification for the current region
