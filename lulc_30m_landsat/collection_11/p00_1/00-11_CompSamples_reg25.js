 ...
 * OBJECTIVE: Extraction of complementary training samples for land cover classification, focusing on the region 'reg_25'.
 * 
 * DESCRIPTION:
 * This script automates the process of collecting training samples across multiple years and classes 
 * within the Atlantic Forest biome, specifically configured for the region identified as 'reg_25'. 
 ...
 * user-defined geometries for specific land cover classes including Forest (900 samples), 
 * Wetland/Varzea (2000 samples), and Agriculture (1500 samples). The resulting feature 
...
var varzea = /* color: #61fcff */ee.FeatureCollection(
        [ee.Feature(
            ee.Geometry.Polygon(
        ...
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-54.39040730054799, -23.82329976240281],
                  [-54.381309247569476, -23.81686116551403],
                  [-54.39727375562612, -23.816075948920368]]]),
            {
              "reference": 11,
              "system:index": "65"
            }),
        ...
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-53.557873579233416, -22.75505348422373],
                  [-53.567143293588884, -22.769299780113894],
                  [-53.5568436109717, -22.769616347584368]]]),
            {
              "reference": 11,
              "system:index": "78"
            })]),
    ...
    agro = /* color: #98ff00 */ee.FeatureCollection(
        ...
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-54.71098028820797, -21.710418984349598],
                  [-54.70480047863766, -21.723177189205092],
                  [-54.693384997070275, -21.722698776944487],
                  [-54.688921801269494, -21.714166824392898]]]),
            {
              "reference": 21,
              "system:index": "29"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-54.55312516946614, -22.1882883627569],
                  [-54.54763200540364, -22.179068990791663],
                  [-54.55449846048177, -22.177479382768087]]]),
            {
              "reference": 21,
              "system:index": "30"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-54.92597368020833, -22.438881102599574],
                  [-54.921853807161455, -22.44491021946111],
                  [-54.91567399759114, -22.43983308584012]]]),
            {
              "reference": 21,
              "system:index": "31"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-53.96845831176611, -22.67872261836863],
                  [-53.96708502075049, -22.64894230135891],
                  [-53.9787579943833, -22.651793888061952]]]),
            {
              "reference": 21,
              "system:index": "32"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-53.99043096801611, -22.639436584681125],
                  [-53.98631109496924, -22.627711961552937],
                  [-54.00794042846533, -22.62961331974413]]]),
            {
              "reference": 21,
              "system:index": "33"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-54.026823179930176, -22.667318154281503],
                  [-54.008627073973145, -22.647674910481634],
                  [-54.03643621703955, -22.658130535350264]]]),
            {
              "reference": 21,
              "system:index": "34"
            })]);
...
// Filter the master collection to obtain the specific geometry of region 'reg_25'
...
for (var i = 0; i < dicExp.length; i++) {
  ...
  for (var i_ano=0; i_ano<anos.length; i_ano++){
    ...
    // Define the specific subset of band names to be used as features for the sampling process for 'reg_25'
    var bandNames = ee.List([
      ...
      'swir2_median',	'gcvi_amp',	'evi2_median_wet',	'red_min',	'red_median_wet',	'savi_amp',	'hallheigth_median_wet',	'gcvi_stdDev',	
      'red_max',	'gcvi_median',	'fns_min',	'hallcover_max',	'blue_median',	'ndwi_median',	'hallcover_median_wet',	'hallheigth_median_dry',	
      'savi_stdDev',	'gcvi_min',	'ndwi_amp',	'nir_min',	'swir1_median',	'evi2_stdDev',	'red_median', 'latitude', 'longitude', 'slope',
    ]);
    ...
    var classConfigs = [
      {variable: typeof flo     !== 'undefined' ? flo     : null, number:  900, ref: 3,  name: 'floresta'},
    ...
    // --- 3. SAMPLING FUNCTION ---
    // Function designed to extract raster pixel values using spatial geometries for region 'reg_25'
    var getTrainingSamples = function(classObj) {
      // Filter the class geometries by the current regional limit ('reg_25')
    ...
    // Iterate through active classes to collect samples for the specific year in region 'reg_25'
  ...
  // Export the final multi-year batch collection for 'reg_25' as an Earth Engine Asset
...
// Print the names of classes that were successfully processed to the console for verification in 'reg_25'
